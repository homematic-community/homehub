                            ...
                            . '<div class="form-inline">'
                                . '<div class="input-group">'
                                    ...
                                    . '<span class="input-group-btn">'
                                        . '<button  data-toggle="collapse" data-target="#' . $modalId . '" class="btn btn-primary set" data-datapoint="4" data-set-id="' . $component['ise_id'] . '" data-set-value="">OK</button>'
                                    . '</span>'
                                . '</div>'
                            . '</div>'
                        . '</div>'
                        ...
                        . '<div class="row text-center">'
                            . '<div class="form-inline">'
                                . '<div class="input-group">'
                                    ...
                                    . '<span class="input-group-btn">'
                                        . '<button  data-toggle="collapse" data-target="#' . $modalId . '" class="btn btn-primary set" data-datapoint="20" data-set-id="' . $component['ise_id'] . '" data-set-value="">OK</button>'
                                    . '</span>'
                                . '</div>'
                            . '</div>'
                        . '</div>'
