        ...
        return '<div class="hh" style=\'border-left-color: '.$component['color'].'; border-left-style: solid;\'>'
            ...
            . '<div class="hh2 collapse" id="' . $modalId . '">'
                . '<div class="row text-center">'
                    ...
                    . '</div><br>'                   
                    . '<div class="btn-group">'
                        . '<button type="button" class="btn btn-primary set" data-set-id="' . $component['LEVEL_2'] . '" data-set-value="1.0">'
                            . '<img src="icon/fts_blade_arc_00.png" />'
                        . '</button>'
                        . '<button type="button" class="btn btn-primary set" data-set-id="' . $component['LEVEL_2'] . '" data-set-value="0.8">'
                            . '<img src="icon/fts_blade_arc_20.png" />'
                        . '</button>'
                        . '<button type="button" class="btn btn-primary set" data-set-id="' . $component['LEVEL_2'] . '" data-set-value="0.6">'
                            . '<img src="icon/fts_blade_arc_40.png" />'
                        . '</button>'
                        . '<button type="button" class="btn btn-primary set" data-set-id="' . $component['LEVEL_2'] . '" data-set-value="0.4">'
                            . '<img src="icon/fts_blade_arc_60.png" />'
                        . '</button>'
                        . '<button type="button" class="btn btn-primary set" data-set-id="' . $component['LEVEL_2'] . '" data-set-value="0.2">'
                            . '<img src="icon/fts_blade_arc_80.png" />'
                        . '</button>'
                        . '<button type="button" class="btn btn-primary set" data-set-id="' . $component['LEVEL_2'] . '" data-set-value="0.0">'
                            . '<img src="icon/fts_blade_arc_100.png" />'
                        . '</button>'
                    . '</div>'                   
                . '</div>'
