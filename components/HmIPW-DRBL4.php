...
function HmIPW_DRBL4($component) {
    ...
    $channel = intval(substr($component['address'], strpos($component['address'], ':') + 1, 2));
    ...
    $key = array_search(substr($component['address'], 0, strpos($component['address'], ':') + 1).$stat_channel, array_column($obj['channels'], 'address'));
