...
function HmIP_SWD($component) {
    ...
    if ($component['parent_device_interface'] == 'HmIP-RF' && $component['visible'] == 'true' && isset($component['ALARMSTATE'])) {
      if (!isset($component['color'])) $component['color'] = '#595959';
        return '<div class="hh" style=\'border-left-color: '.$component['color'].'; border-left-style: solid;\'>'
            ...
            . '<div class="pull-right">'
                ...
                . '<span class="right info" data-id="' . $component['ALARMSTATE'] . '" data-component="' . $component['component'] . '" data-datapoint="ALARMSTATE"></span>'
            . '</div>'
