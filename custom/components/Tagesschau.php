...
function Tagesschau($component) {
    ...
    if (file_exists($cacheFile) && (filemtime($cacheFile) > (time() - 60 * 5 ))) {
        ...
        $rssFeed = file_get_contents('https://www.tagesschau.de/export/video-podcast/webxl/tagesschau-in-100-sekunden/');
    ...
    return '<div class="hh">'
        . '<div data-toggle="collapse" data-target="#' . $modalId . '">'
            . '<img src="icon/' . $component["icon"] . '" class="icon">Tagesschau in 100 Sekunden'
        . '</div>'
