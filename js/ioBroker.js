                        ...
                        case 'ioBroker':
                            switch (datapoint) {
                                case 'midasmode':
                                    switch (value) {
                                        case '-1':
                                            $('[id="' + ise_id + '_-1"]').addClass('btn-true');
                                            $('[id="' + ise_id + '_-1"]').removeClass('btn-false');
                                            $('[id="' + ise_id + '_-1"]').removeClass('btn-text');
                                            $('[id="' + ise_id + '_0"]').addClass('btn-text');
                                            $('[id="' + ise_id + '_1"]').addClass('btn-text');
                                            $('[id="' + ise_id + '_2"]').addClass('btn-text');
                                            $('[id="' + ise_id + '_0"]').removeClass('btn-true');
                                            $('[id="' + ise_id + '_1"]').removeClass('btn-true');
                                            $('[id="' + ise_id + '_2"]').removeClass('btn-true');
                                            break;
                                        case '0':
                                            $('[id="' + ise_id + '_0"]').addClass('btn-true');
                                            $('[id="' + ise_id + '_0"]').removeClass('btn-false');
                                            $('[id="' + ise_id + '_0"]').removeClass('btn-text');
                                            $('[id="' + ise_id + '_-1"]').addClass('btn-text');
                                            $('[id="' + ise_id + '_1"]').addClass('btn-text');
                                            $('[id="' + ise_id + '_2"]').addClass('btn-text');
                                            $('[id="' + ise_id + '_-1"]').removeClass('btn-true');
                                            $('[id="' + ise_id + '_1"]').removeClass('btn-true');
                                            $('[id="' + ise_id + '_2"]').removeClass('btn-true');
                                            break;
                                        case '1':
                                            $('[id="' + ise_id + '_1"]').addClass('btn-true');
                                            $('[id="' + ise_id + '_1"]').removeClass('btn-false');
                                            $('[id="' + ise_id + '_1"]').removeClass('btn-text');
                                            $('[id="' + ise_id + '_0"]').addClass('btn-text');
                                            $('[id="' + ise_id + '_-1"]').addClass('btn-text');
                                            $('[id="' + ise_id + '_2"]').addClass('btn-text');
                                            $('[id="' + ise_id + '_0"]').removeClass('btn-true');
                                            ...
                                            break;
                                        case '2':
                                            $('[id="' + ise_id + '_2"]').addClass('btn-true');
                                            $('[id="' + ise_id + '_2"]').removeClass('btn-false');
                                            $('[id="' + ise_id + '_2"]').removeClass('btn-text');
                                            $('[id="' + ise_id + '_0"]').addClass('btn-text');
                                            $('[id="' + ise_id + '_1"]').addClass('btn-text');
                                            $('[id="' + ise_id + '_-1"]').addClass('btn-text');
                                            $('[id="' + ise_id + '_0"]').removeClass('btn-true');
...
var setDatapointIoBroker = function(id, value, datapoint, ioBrokerAPI) {
    if (datapoint == "toggle") {
        ...
        value = document.getElementById(id + 'submit').value
        if (value !== undefined && datapoint !== undefined) {
            url = ioBrokerAPI + '/set/' + id + '?value=' + value
            //console.log(url);
            $.ajax({
