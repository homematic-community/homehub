<?php
if(isset($_GET['transition_duration'])) {
	if($_GET['transition_duration'] != "0" and is_numeric($_GET['transition_duration']))
	{
	 $transition_duration = $_GET['transition_duration'];
	} else {
...
function(a) {
    ...
    function l(o) {
        return this.each(function() {
            ...
            i = a.extend({},
            r.DEFAULTS, t.data(), "object" == typeof o && o); ! e && i.toggle && /show|hide/.test(o) && (i.toggle = !1),
            e || t.data("bs.collapse", e = new r(this, i)),
            "string" == typeof o && e[o]()
        })
    }
    r.VERSION = "3.4.1",
    r.TRANSITION_DURATION = <?php echo $transition_duration; ?>,
    r.DEFAULTS = {
        toggle: !0
    },
